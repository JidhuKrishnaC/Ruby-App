...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { dob: @developer.dob, email: @developer.email, firstname: @developer.firstname, lastname: @developer.lastname, user_id: @developer.user_id } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { dob: @developer.dob, email: @developer.email, firstname: @developer.firstname, lastname: @developer.lastname, user_id: @developer.user_id } }
